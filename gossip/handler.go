...
import (
	...
	"github.com/galaxy-digital/spesbas-base/eventcheck/queuedcheck"
	"github.com/galaxy-digital/spesbas-base/gossip/dagprocessor"
	"github.com/galaxy-digital/spesbas-base/gossip/dagstream"
	"github.com/galaxy-digital/spesbas-base/gossip/dagstream/streamleecher"
	"github.com/galaxy-digital/spesbas-base/gossip/dagstream/streamseeder"
	"github.com/galaxy-digital/spesbas-base/gossip/itemsfetcher"
	...
	"github.com/galaxy-digital/spesbas-base/utils/datasemaphore"

	"github.com/galaxy-team/spesbas-chain/eventcheck"
	"github.com/galaxy-team/spesbas-chain/eventcheck/parentlesscheck"
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping dbas-galaxy protocol")
	...
	log.Info("dbas-galaxy protocol stopped")
}
