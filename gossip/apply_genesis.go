...
import (
	...
	"github.com/galaxy-team/spesbas-chain/inter/drivertype"
)

// ApplyGenesis writes initial state.
func (s *Store) ApplyGenesis(blockProc BlockProc, g galaxy.Genesis) (genesisHash hash.Hash, err error) {
...
func (s *Store) applyEpoch0Genesis(g galaxy.Genesis) (evmBlock *evmcore.EvmBlock, err error) {
...
func (s *Store) applyEpoch1Genesis(blockProc BlockProc, g galaxy.Genesis) (err error) {
	...
	prettyHash := func(root common.Hash, g galaxy.Genesis) hash.Event {
