...
import (
	...
	"github.com/galaxy-digital/spesbas-base/lachesis"
	"github.com/galaxy-digital/spesbas-base/utils/workers"

	"github.com/galaxy-team/spesbas-chain/ethapi"
	"github.com/galaxy-team/spesbas-chain/eventcheck"
	...
	"github.com/galaxy-team/spesbas-chain/gossip/blockproc"
	"github.com/galaxy-team/spesbas-chain/gossip/blockproc/drivermodule"
	"github.com/galaxy-team/spesbas-chain/gossip/blockproc/eventmodule"
	"github.com/galaxy-team/spesbas-chain/gossip/blockproc/evmmodule"
	"github.com/galaxy-team/spesbas-chain/gossip/blockproc/sealmodule"
	"github.com/galaxy-team/spesbas-chain/gossip/blockproc/verwatcher"
	"github.com/galaxy-team/spesbas-chain/gossip/emitter"
	"github.com/galaxy-team/spesbas-chain/gossip/filters"
	"github.com/galaxy-team/spesbas-chain/gossip/gasprice"
	"github.com/galaxy-team/spesbas-chain/inter"
	"github.com/galaxy-team/spesbas-chain/logger"
	"github.com/galaxy-team/spesbas-chain/utils/gsignercache"
	"github.com/galaxy-team/spesbas-chain/utils/wgmutex"
...
func (s *Service) Stop() error {
	defer log.Info("dbas-galaxy service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
