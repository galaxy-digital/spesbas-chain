...
import (
	...
	"github.com/galaxy-digital/spesbas-base/utils/cachescale"
	...
	"github.com/galaxy-team/spesbas-chain/gossip"
	"github.com/galaxy-team/spesbas-chain/gossip/gasprice"
	"github.com/galaxy-team/spesbas-chain/integration"
	"github.com/galaxy-team/spesbas-chain/integration/makegenesis"
...
var (
	...
	RPCGlobalGasCapFlag = cli.Uint64Flag{
		Name:  "rpc.gascap",
		Usage: "Sets a cap on gas that can be used in dbas_call/estimateGas (0=infinite)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCGasCap,
	}
	RPCGlobalTxFeeCapFlag = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in DBAS) that can be sent via the RPC APIs (0 = no cap)",
...
func getGalaxyGenesis(ctx *cli.Context) integration.InputGenesis {
	...
	case ctx.GlobalIsSet(FakeNetFlag.Name):
		...
		fakeGenesisStore := makegenesis.FakeGenesisStore(num, futils.ToDbas(10000000000), futils.ToDbas(5000000))
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "eth", "dbas", "dag", "sfc", "abft", "web3")
	cfg.WSModules = append(cfg.WSModules, "eth", "dbas", "dag", "sfc", "abft", "web3")
