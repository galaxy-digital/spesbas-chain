...
import (
	...
	"github.com/galaxy-team/spesbas-chain/gossip/sfcapi"
)
...
func RPCMarshalStaker(it sfcapi.SfcStakerAndID) map[string]interface{} {
	return map[string]interface{}{
...
func (s *PublicSfcAPI) addStakerMetricFields(ctx context.Context, res map[string]interface{}, stakerID idx.ValidatorID) (map[string]interface{}, error) {
	...
	validationScore, err := s.b.GetUptime(ctx, stakerID)
	if err != nil {
		return nil, err
	}
	res["validationScore"] = (*hexutil.Big)(validationScore)

	originationScore, err := s.b.GetOriginatedFee(ctx, stakerID)
	if err != nil {
		return nil, err
	}
...
func (s *PublicSfcAPI) addDelegationMetricFields(ctx context.Context, res map[string]interface{}, id sfcapi.DelegationID) (map[string]interface{}, error) {
...
func (s *PublicSfcAPI) GetStaker(ctx context.Context, stakerID hexutil.Uint, verbosity hexutil.Uint64) (map[string]interface{}, error) {
	...
	it := sfcapi.SfcStakerAndID{
		StakerID: idx.ValidatorID(stakerID),
		Staker:   staker,
	}
	...
	return s.addStakerMetricFields(ctx, stakerRPC, idx.ValidatorID(stakerID))
}
...
func RPCMarshalDelegation(it sfcapi.SfcDelegationAndID) map[string]interface{} {
	return map[string]interface{}{
